        ...
        <div class="container">
            <div class="blog-details-content">
                <div class="blog-details-img text-center">
                    <!-- Tambahkan class "text-center" untuk membuat gambar berada di tengah secara horizontal -->
                    <img src="../../images/{{ $blog->image }}"
                        style="display: inline-block; vertical-align: middle;">
                    <!-- Style inline untuk mengatur tampilan gambar di tengah secara vertikal -->
                </div>
                <h2>{{ $blog->title }}</h2>
