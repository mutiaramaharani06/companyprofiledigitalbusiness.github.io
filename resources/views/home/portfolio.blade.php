        ...
        <div class="container mw-1680">
            <div class="page-banner-content">
                ...
                <ul class="ps-0 mb-0 list-unstyled justify-content-center page-breadcrumb d-flex flex-wrap gap-4">
                    ...
                    <li>
                        <span class="active">Portofolio</span>
                    </li>
                </ul>
            </div>
        </div>
                ...
                @foreach ($portfolio as $portofolio)
                    <div class="col-lg-4 col-md-6">
                        <div class="recent-cases-single-item style-two mb-4">
                            <a class="tag">{{ $portofolio->namabidang }}</a>
                            <h3>
                                <a>{{ $portofolio->title }}</a>
                            </h3>
                            <a class="cases-img">
                    ...
                    <!-- <div class="col-lg-4 col-md-6">
      <div class="recent-cases-single-item style-two mb-4">
       <a href="/cases-study-details" class="tag">{{ $portofolio->namabidang }}</a>
       <h3>
        <a href="/cases-study-details">{{ $portofolio->title }}</a>
       </h3>
       <a href="/cases-study-details" class="cases-img">
        <img src="../images/{{ $portofolio->image }}" alt="cases">
       </a>
       <p>{{ $portofolio->description }}</p>
      </div>
