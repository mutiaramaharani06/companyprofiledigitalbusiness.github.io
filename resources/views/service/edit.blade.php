        ...
        <div class="col-md-12">
            ...
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="label" placeholder="Bidang 1" value="{{ $service->label }}">
                </div>
                @error('title')
                <small style="color:red">{{$message}}</small>
                @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="label1" placeholder="Bidang 2" value="{{ $service->label1 }}">
                </div>
                @error('title')
                <small style="color:red">{{$message}}</small>
                @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="label2" placeholder="Bidang 3" value="{{ $service->label2 }}">
                </div>
                @error('title')
                <small style="color:red">{{$message}}</small>
                @enderror
