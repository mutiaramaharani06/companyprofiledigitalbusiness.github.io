...
class ServiceController extends Controller
{
    ...
    {
        $request->validate([
            'title' => 'required', 'description' => 'required','label' => 'required','label1' => 'required','label2' => 'required','image' => 'required|image',
        ]);
    ...
    {
        $request->validate([
            'title' => 'required', 'description' => 'required','label' => 'required','label1' => 'required','label2' => 'required', 'image' => 'image',
        ]);
